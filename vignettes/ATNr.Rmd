...
**Note: in all the different example scripts, generating the food webs is what is the most complicated. We could maybe simplify everything by adding all the checks directly in the generative function. I mean, it seems rather OK to not return a food web with disconnected components, no?**
