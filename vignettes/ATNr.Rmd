...
### forget that the model objects are formally pointers to C++ classes

This is associated to different issues: 
...
However, this behaviour is not present when using a parrallel version of an apply function:
