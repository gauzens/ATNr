...
However, this behaviour is not present when using a parrallel version of an apply function, as in parallel computations the object is automatically deep-copied and passed to each task separately:
