...
RcppExport SEXP _rcpp_module_boot_Unscaled_nuts_ecoModule();
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_rcpp_module_boot_Unscaled_nuts_ecoModule", (DL_FUNC) &_rcpp_module_boot_Unscaled_nuts_ecoModule, 0},
