...
RcppExport SEXP _rcpp_module_boot_Schneider_arma_prefModule();
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_rcpp_module_boot_Schneider_arma_prefModule", (DL_FUNC) &_rcpp_module_boot_Schneider_arma_prefModule, 0},
